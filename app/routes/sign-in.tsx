        ...
        >
          ...
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: "linear-gradient(135deg, rgba(99, 102, 241, 0.03) 0%, transparent 50%, rgba(16, 185, 129, 0.03) 100%)",
              pointerEvents: "none",
              opacity: 0,
          ...
          <div style={{ textAlign: "center", marginTop: "24px", fontSize: "14px", color: "#6b7280", position: "relative" }}>
            ...
            >
              <span className="group-hover:text-gray-600 transition-colors">Sign up</span>
              <span
                style={{
                  position: "absolute",
                  bottom: "-2px",
