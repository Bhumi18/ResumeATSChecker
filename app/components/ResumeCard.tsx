  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2">
        <h2 className="text-ink-900 font-bold break-words text-xl group-hover:text-ink-500 transition-colors">
          {companyName || 'No Company'}
        </h2>
        <h3 className="text-base break-words text-ink-500 font-medium">
          {jobTitle || 'No Job Title'}
        </h3>
        <p className="text-sm text-ink-400 line-clamp-3 mt-1 leading-relaxed">
        ...
        <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between text-xs">
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-1">
              ...
              <span className="text-ink-500">ATS: {feedback.ATS.score}%</span>
            </div>
            <div className="flex items-center gap-1">
              <svg className="w-4 h-4 text-ink-400" fill="currentColor" viewBox="0 0 20 20">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clipRule="evenodd" />
              </svg>
              <span className="text-ink-500">Content: {feedback.content.score}%</span>
            </div>
          </div>
          <div className="text-ink-700 font-medium group-hover:translate-x-1 transition-transform">
            View Details →
          </div>
        </div>
      )}
